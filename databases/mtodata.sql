...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2023 at 05:05 PM
...
(1, 'President', 'sample', 'admin', '', '', '01234566789', 'admin@example.com', 'sampleadmin', 'admin123', '2023-07-08 15:05:18');
...
ALTER TABLE `complaint_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `complaint_id` (`complaint_person`),
