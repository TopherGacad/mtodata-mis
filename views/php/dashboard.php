...
<body>
    ...
    <div class="dashboard-container" id="dash-container">
        ...
        <div class="botright-dash border">
            <div class="card-header">
                <h4>Member Age Range</h4>
            </div>
            <canvas id="ageChart" style="width:100%;max-width:600px;height: 300px;"></canvas>
        </div>
    </div>
    ...
    <div class="users-container" id="users-container">
        <header>
            ...
            <p>ADMIN VIEW</p>
            <button class="usermoreBtn"><i class="fa-solid fa-ellipsis"></i></i></button>
            ...
            <div class="form-container">
                ...
                <div class="memForm-left">
                    ...
                    <div class="fields">
                        ...
                        <input type="text" id="user-lastname" name="lastname" placeholder="Lastname">
                    </div>
                    <!-- FIRSTNAME -->
                    <div class="fields">
                    ...
                    <div class="fields">
                        ...
                        <input type="text" id="user-midname" name="middlename" placeholder="Middlename" required>
                    </div>
                    <!-- EXTENSION NAME -->
                    <div class="fields">
                ...
                <div class="memForm-right">
                    ...
                    <div class="btn-container">
                        <input type="submit" value="Cancel" class="cancel-btn" id="adduser-cancel" formnovalidate>
    ...
    <div class="editUser-modal-container" id="editUser-modal">
        ...
        <div class="btn-container">
            <input type="submit" value="Cancel" class="cancel-btn" id="editUser-cancel" formnovalidate>
            <button class="save-btn" id="save-btn" type="submit">Save</button>
        </div>
    </div>
            ...
            <div class="form-container">
                ...
                <div class="memForm-left">
                    ...
                    <div class="fields">
                        ...
                        <input type="text" id="mem-lastname" name="lastname" placeholder="Lastname">
                    </div>
                    <!-- FIRSTNAME -->
                    <div class="fields">
                    ...
                    <div class="fields">
                        ...
                        <input type="text" id="mem-age" pattern="[0-9]{3}" name="age" required>
                    </div>
                </div>
                ...
                <div class="memForm-right">
                    ...
                    <div class="btn-container">
                        <input type="submit" value="Cancel" class="cancel-btn" id="member-cancel" formnovalidate>
                        <button class="save-btn" id="save-btn" type="submit">Save</button>
                    </div>
                </div>
            </div>
