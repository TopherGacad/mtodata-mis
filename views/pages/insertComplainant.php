...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO complaint_info (lname, fname, mname, exname, gender, phone) VALUES ('$complaintLastName', '$complaintFirstName', '$complaintMiddleName', '$complaintExtensionName', '$complaintGender', '$contactNumber')";
        if (mysqli_query($conn, $sql)) {
            ...
            $sql = "INSERT INTO complaint_details (complaint_person, body_no, details, date_created, complainant_id) VALUES ('$personToComplain', '$bodyNumber', '$description', '$dateCreated', '$complaintId')";
            if (mysqli_query($conn, $sql)) {
                $complaintDetailsId = mysqli_insert_id($conn);
                echo "Complaint details inserted successfully with ID: $complaintDetailsId<br>";
            } else {
                    ...
                    <div class="main">
                        ...
                        <div class="right-side-profile section">
                            ...
                            <div class="fields">
                                ...
                                <input type="text" id="complaintSubjectBody" name="complaintSubjectBody">
                            </div>
                        </div>
                    </div>
                </div>
