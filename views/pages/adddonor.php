            ...
            <div class='user-container'>
                ...
                <div class='main'>
                    <div class='left-side-emp section'>
                        <!-- LASTNAME -->
                        <div class='fields'>
                            <label for='donor-last'>Donor's Lastname <span> *</span></label>
                            <input type="text" id="donor-last" name="donor_last" placeholder="Dela Cruz" required>
                        </div>

                        <!-- FIRSTNAME -->
                        <div class='fields'>
                            <label for='donor-first'>Donor's Firstname <span> *</span></label>
                    ...
                    <div class='right-side-emp section'>
                        <!-- MIDDLENAME -->
                        <div class='fields'>
                            <label for='donor-mid'>Donor's Middlename <span> *</span></label>
                            <input type="text" id="donor-mid" name="donor_mid" placeholder="Reyes" required>
                        </div>

                        <!-- EXTENSION NAME -->
                        <div class='fields'>
                            <label for='donor-ext'> Extension name<span> *</span></label>
                            <input type="text" id="donor-ext" name="donor_ext" placeholder="eg. Jr, Sr" required> 
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class='main'>
                    ...
                    <div class='right-side-profile section'>
                        ...
                        <div class="fields">
                            ...
                            <input type="text" name="donor-contact" id="donor_contact" required>
                        </div>
                    </div>
                </div>
            </div>
